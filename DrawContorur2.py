...
img_dilation = cv2.dilate(rotated90, None, iterations=10)
img_erosion = cv2.erode(img_dilation, None, iterations=10)
edged=cv2.Canny(img_erosion,30,200)
contours, hierarchy=cv2.findContours(edged,cv2.RETR_EXTERNAL,cv2.cv2.CHAIN_APPROX_SIMPLE )
...
img_dilation = cv2.dilate(rotated90, None, iterations=5)
